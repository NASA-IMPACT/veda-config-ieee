...
usage:
  - url: 'https://github.com/NASA-IMPACT/ieee-veda-notebooks/blob/main/social-vulnerability.ipynb'
    label: View example notebook
    title: 'Open and Visualize SVI data'
  - url: "https://nasa-veda.2i2c.cloud/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FNASA-IMPACT%2Fieee-veda-notebooks&urlpath=tree%2Fieee-veda-notebooks%2Fsocial-vulnerability.ipynb&branch=main"
