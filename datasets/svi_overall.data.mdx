...
usage:
  - url: 'https://github.com/NASA-IMPACT/ieee-veda-notebooks/blob/main/veda-stac-raster-interaction.ipynb'
    label: View example notebook
    title: 'Open and Visualize SVI data'
  - url: "https://hub.grss.cloud/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FNASA-IMPACT%2Fieee-veda-notebooks&urlpath=lab%2Ftree%2Fieee-veda-notebooks%2Fveda-stac-raster-interaction.ipynb
&branch=main"
    label: Interactively run example notebook in JupyterHub
    title: 'Open and Visualize SVI data'
media:
